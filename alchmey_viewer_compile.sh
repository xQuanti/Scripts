...
sudo apt install -y libglu1-mesa-dev libgl-dev libegl1-mesa-dev libgles2-mesa-dev libvulkan-dev libasound2-dev \
    ...
    libnspr4 libnspr4-dev libnss3 libnss3-dev graphviz cmake gcc-10 g++-10 libfontconfig1-dev python3-pip
...
#TODO: Create flatpak package for alchemy-next for isolating it from system after compile
